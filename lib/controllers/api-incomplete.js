...
exports.retrieveTweetsUsingIndex = function(req, res) {
  ...
  // Lab 2:TODO 4: Execute query

  // Lab 2:TODO 5: Add 'data', 'error' and 'end' event handlers to process query result. 
  // HINT: In 'data' handler you will add bins tweet, key, uid and ts to tweets map with ts being the key for each map entry
  // HINT: In 'end' handler you will return status 'Ok' and tweets map populated in 'data' handler
};
